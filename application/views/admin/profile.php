            ...
            <div class="col-md-12">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputfnm" placeholder="Enter Username" name="uname" value="<?php echo $profile['uname'] ?>">
                ...
                <div class="form-group">
                  ...
                  <input type="file" class="form-control" id="exampleInputimg"  name="profile_image">
                </div>
              </div>
              <div class="col-md-4">
                <img src="<?php echo base_url();  ?>/uploads/profile_pics/<?php echo $profile['profile_image'] ?>" class="img-thumbnail" height="100" width="100">
              </div>
