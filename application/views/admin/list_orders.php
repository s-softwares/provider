<?php
   ...
   if ($type == 'admin') {
      ...
      $orders = $this->admin_model->get_all_vendor_orders($aid);
   }
?>
                              ...
                              <?php foreach ($orders as $row) { ?>
                                 <tr>
                                    ...
                                    <td style="display: inline-flex;">
                                       <a href="<?php echo base_url('admin/view-order/' . $row->id) ?>" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="View"><span class="fa fa-eye"></span></a>

                                       <button data-i="<?php echo $row->id; ?>" class="btn btn-sm btn-danger delete margin-5" data-toggle="tooltip" data-placement="bottom" data-original-title="Delete"><i class="fa fa-trash"></i></button>
