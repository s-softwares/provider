         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item"><a href="<?php echo base_url('admin/orders'); ?>">Orders List</a></li>
            ...
            <div class="col-12">
               ...
               <div class="invoice p-3 mb-3">
                  ...
                  <div class="row">
                     <div class="col-12">
                        <h4>
                           <i class="fas fa-globe"></i> Eshield
                     ...
                     <div class="col-12 table-responsive">
                        <table class="table table-striped">
                           ...
                           <tbody>
                              ...
                              $product = $this->admin_model->get_order_items_by_id($order_id);
                              $no = 0;
                              ...
                              ?>
                                 <tr>
                                    ...
                                    <td><span class='badge badge-success'><?php echo $cart_item->qty; ?></span></td>
                                    <td>
                                       <?php
                                       if (!empty($product_nm)) {
                                    ...
                                    <td>
                                       ...
                                       if (!empty($product_nm)) {
                                          ...
                                          echo $product_nm->product_price * $cart_item->qty;
                                       } ?>
