                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 ...
                                 <div class="input-group">
                                    <input type="number" class="form-control" id="exampleInputfnm" placeholder="Enter Phone Number" name="res_phone" value="<?php echo $restaurant->res_phone; ?>">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <div class="input-group">
                                    <input type="text" class="form-control" id="exampleInputfnm" placeholder="Enter Website" name="res_website" value="<?php echo $restaurant->res_website; ?>">
                                    <div class="input-group-append">
                                       <div class="input-group-text">
                           ...
                           <div class="row">
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputfnm" placeholder="00:00" name="monday_from" value="<?php echo $restaurant->monday_from; ?>">
                                 </div>
                              </div>
                              ...
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputfnm" placeholder="00:00" name="monday_to" value="<?php echo $restaurant->monday_to; ?>">
                                 </div>
                              </div>
                              ...
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputfnm" placeholder="00:00" name="tuesday_from" value="<?php echo $restaurant->tuesday_from; ?>">
                                 </div>
                              </div>
                              ...
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputfnm" placeholder="00:00" name="tuesday_to" value="<?php echo $restaurant->tuesday_to; ?>">
                                 </div>
                              </div>
                              ...
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputfnm" placeholder="00:00" name="wednesday_from" value="<?php echo $restaurant->wednesday_from; ?>">
                                 </div>
                              </div>
                              ...
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputfnm" placeholder="00:00" name="wednesday_to" value="<?php echo $restaurant->wednesday_to; ?>">
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="row">
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputfnm" placeholder="00:00" name="thursday_from" value="<?php echo $restaurant->thursday_from; ?>">
                                 </div>
                              </div>
                              ...
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputfnm" placeholder="00:00" name="thursday_to" value="<?php echo $restaurant->thursday_to; ?>">
                                 </div>
                              </div>
                              ...
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputfnm" placeholder="00:00" name="friday_from" value="<?php echo $restaurant->friday_from; ?>">
                                 </div>
                              </div>
                              ...
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputfnm" placeholder="00:00" name="friday_to" value="<?php echo $restaurant->friday_to; ?>">
                                 </div>
                              </div>
                              ...
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputfnm" placeholder="00:00" name="saturday_from" value="<?php echo $restaurant->saturday_from; ?>">
                                 </div>
                              </div>
                              ...
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputfnm" placeholder="00:00" name="saturday_to" value="<?php echo $restaurant->saturday_to; ?>">
                                 </div>
                              </div>
                              ...
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputfnm" placeholder="00:00" name="sunday_from" value="<?php echo $restaurant->sunday_from; ?>">
                                 </div>
                              </div>
                              ...
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputfnm" placeholder="00:00" name="sunday_to" value="<?php echo $restaurant->sunday_to; ?>">
                                 </div>
                              </div>
                           </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="store_address" rows="2" placeholder="Search Your Store Location" id="pac-input"><?php echo $restaurant->res_address; ?></textarea>
