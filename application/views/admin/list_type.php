...
// $id = $this->session->userdata('aid');
  $type = $this->admin_model->get_all_type();
?>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="nav-icon fa fa-tumblr-square"></i> Type</h1>
          </div>
          <div class="col-sm-6">
                  ...
                  <table id="list_table" class="table table-bordered table-striped">
                     ...
                     <tr>
                       ...
                       <td style="display: inline-flex;">
                         <a class="btn btn-sm btn-info margin-5" href="<?php echo base_url('admin/edit-type/'.$row->id); ?>"><i class="fa fa-edit"></i></a>
...
<div class="modal fade in" id="modalDel">
  <div class="modal-dialog" >
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo base_url('admin/trash-type'); ?>" id="frmDel">
