          ...
          <div class="row mb-2">
             ...
             <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                   ...
                   <li class="breadcrumb-item"><a href="<?php echo base_url('admin/booking-list'); ?>">Booking List</a></li>
                ...
                <div class="invoice p-3 mb-3">
                         ...
                         <h4>
                            <?php
                              ...
                              if ($profile[0] == "https" || $profile[0] == "http") { ?>
                               <img src="<?php echo $user['profile_pic'] ?>" class="profile-user-img img-responsive img-circle" style="height:100px;width:100px">
                            <?php } else { ?>
                               <?php if (empty($user['profile_pic'])) { ?>
                                  <img src="<?php echo base_url('uploads/profile_pics/user.png') ?>" class="profile-user-img img-responsive img-circle" style="height:100px;width:100px">
                               <?php } else { ?>
                                  <img src="<?php echo base_url('uploads/profile_pics/') . $user['profile_pic'] ?>" class="profile-user-img img-responsive img-circle" style="height:100px;width:100px"> <?php } ?>
                            <?php } ?>
                   ...
                   <div class="row invoice-info">
                      ...
                      <div class="col-sm-4 invoice-col">
                         ...
                         <p><b>PAYMENT Mode: </b> <?php echo $booking->payment_mode; ?><br></p>
                      ...
                      <div class="col-sm-4 invoice-col">
                         ...
                         <?php if (!empty($service['service_name'])) { ?>
                            <h4><strong>Service Name :</strong> <?php echo $service['service_name']; ?><br></h4>
                         <?php } else { ?>
                            <h4><strong>Service Name :</strong> <br></h4>
                         <?php } ?>
                                        ...
                                        <select name="status" id="status" class="form-control" required>
                                          ...
                                          <option value="On Way" <?php if ($booking->status == "On Way") {
                                           ...
                                           <option value="Completed" <?php if ($booking->status == "Completed") {
                                                                     ...
                                                                     ?>>Completed</option>
                                           <option value="Cancel" <?php if ($booking->status == "Cancel") {
                                                                     echo "selected='selected'";
                                                                  }
                                                                  ?>>Cancel</option>
                                        </select>
