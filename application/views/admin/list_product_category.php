...
$product_category = $this->admin_model->get_all_product_category();
?>
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1><i class="nav-icon fa fa-list"> Product Category</i></h1>
				</div>
				<div class="col-sm-6">
										...
										<?php foreach ($product_category as $row) { ?>
											<tr>
												...
												<td style="display: inline-flex;">
													<a class="btn btn-sm btn-info" href="<?php echo base_url('admin/edit-product-category/' . $row->id); ?>"><i class="fa fa-edit"></i></a>
...
<div class="modal fade in" id="modalDel">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form method="post" action="<?php echo base_url('admin/trash-product-category'); ?>" id="frmDel">
